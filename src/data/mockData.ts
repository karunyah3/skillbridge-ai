  ...
  verifiedBadges: [
    {
      ...
      issuer: "SkillBridge Academia Alliance",
      date: "Nov 2025",
      badgeType: "Platinum",
...
export const LEARNING_ROADMAP_STEPS: LearningStep[] = [
    ...
    resources: [
      {
        ...
        duration: "8 hrs",
        url: "https://skillbridge.ai/learn/python-advanced",
        isFree: true,
        rating: 4.9
      }
    ]
  ...
  },
  {
    ...
    status: "upcoming",
    progressPercent: 0,
    skillsGained: ["SkillBridge Verified AI Practitioner", "AWS Certified Cloud Practitioner", "Resume Benchmark Score 90%+"],
    projectDeliverable: "Verified digital credential added to SkillBridge portfolio and LinkedIn profile.",
    keyTopics: [
    ...
    resources: [
      {
        title: "SkillBridge Proctored Benchmark Exam",
        type: "Practice Lab",
        provider: "SkillBridge Certification Council",
        duration: "2 hrs",
        url: "https://skillbridge.ai/certify",
        isFree: true,
        rating: 4.9
      }
    ]
