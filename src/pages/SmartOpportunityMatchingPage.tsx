              ...
              <div className="space-y-5">
                <div>
                  <div className="inline-flex items-center space-x-1.5 text-xs font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 mb-2">
                    ...
                    <span>BRAIDLY Verified Fast-Track Apply</span>
                  </div>
              ...
              <div className="text-center py-6 space-y-4 animate-in zoom-in-95 duration-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto">
                    Your verified BRAIDLY profile with a <strong className="text-cyan-400 font-mono">{selectedOppForModal.matchScore}% Match Score</strong> was sent directly to {selectedOppForModal.company}'s engineering hiring team.
                  </p>
                </div>
