          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-[#574D43] max-w-2xl font-normal leading-relaxed">
                SkillBridge AI connects academic curriculums with modern industry requirements. Benchmark your competencies, diagnose missing skills with AI gap mapping, follow curated learning programs, and land matched tech internships.
              </p>
